...
namespace HoloPlay
{
    ...
    public class editorDepthTouchTarget : MonoBehaviour
    {
        ...
        public virtual void onDepthTouch(List<AirTouch> touches)
        {
        }
