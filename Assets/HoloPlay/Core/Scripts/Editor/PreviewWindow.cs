...
namespace HoloPlay
{
    public static class PreviewWindow
    {
        ...
        public static void ToggleWindow()
        {
            ...
            if (index == 0)
            {
                Debug.LogWarning(Misc.warningText + "couldn't find standalone resolution in preview window");
            }
    ...
    public class PreviewWindowEditor : EditorWindow
    {
        ...
        void OnEnable()
        {
            displayCorner = Resources.Load<Texture2D>("display_corner");
            displayCorner.filterMode = FilterMode.Point;
        ...
        void OnDisable()
        {
            Resources.UnloadAsset(displayCorner);
